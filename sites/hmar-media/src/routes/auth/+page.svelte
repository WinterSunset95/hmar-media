		...
		<Card.Root class="border-border shadow-xl overflow-hidden bg-background">
			<Tabs.Root value="login" class="w-full">
				...
				<div class="p-4 pb-0">
					<Tabs.List class="grid w-full grid-cols-2 bg-muted/50">
						<Tabs.Trigger class="" value="login">Sign In</Tabs.Trigger>
						<Tabs.Trigger class="" value="signup">Create Account</Tabs.Trigger>
					</Tabs.List>
				</div>
			...
			<Card.Footer class="flex flex-col border-t border-border bg-muted/10 p-4 pt-6 space-y-6">
				...
				<div class="grid grid-cols-2 gap-3 w-full">
					...
					<Button variant="outline" class="w-full bg-transparent hover:bg-muted/50 border-border" disabled={false}>
					...
					<Button variant="outline" class="w-full bg-transparent hover:bg-muted/50 border-border text-foreground" disabled={false}>
